...
/**
 * Created by andresvil on 3/22/16.
 */
public class RetosCompletadosAdapter extends ArrayAdapter {
    private List myList = new ArrayList();

    public RetosCompletadosAdapter(Context context, int resource) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.CHECK.setImageResource(R.drawable.activo);
